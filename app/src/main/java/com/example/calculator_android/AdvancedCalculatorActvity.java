...
public class AdvancedCalculatorActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = findViewById(R.id.resultAdvancedTV);
    ...
    private void updateResult(String newStr) {
        ...
        if(getString(R.string.default_display).equals(result.getText().toString())) {
            ...
            result.setSelection(cursorPos + newStr.length());
        }
    }
    ...
    public void powTwoBTN(View view) {
        updateResult("^2");
    }
    ...
    public void closedParenthesisBTN(View view){
        updateResult(")");
    }
    ...
    public void equalsBTN(View view) {
        ...
        strExpression = strExpression.replaceAll("×", "*");
        strExpression = strExpression.replace("log(", "log(10,");
